...
X_train = df['Column1'] = df['Column1'].astype(float)
y_train = (df[['Column2']])= df['Column2'].astype(float)

#y_train = float(df[['Column2']])
...
# CSV 파일에서 데이터 읽어오기
data = pd.read_excel("C:/Users/yb301/Desktop/231122.xlsx")  # 데이터 파일의 경로와 이름에 맞게 수정해주세요
